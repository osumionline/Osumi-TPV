export class RolGroup {
  constructor(public name: string, public roles: Record<string, Rol> = {}) {}
}
...
export const rolList: Record<string, RolGroup> = {
  ...
  marca: new RolGroup('Marcas', {
    crear: new Rol(2, 'Crear nuevas marcas.', 'Permite al empleado crear una nueva marca.'),
    modificar: new Rol(
      3,
  ...
  proveedor: new RolGroup('Proveedores', {
    crear: new Rol(6, 'Crear nuevos proveedores.', 'Permite al empleado crear un nuevo proveedor.'),
    modificar: new Rol(
      7,
  ...
  articulos: new RolGroup('Artículos', {
    crear: new Rol(10, 'Crear nuevos artículos.', 'Permite al empleado crear un nuevo artículo.'),
    modificar: new Rol(
      11,
  ...
  clientes: new RolGroup('Clientes', {
    crear: new Rol(15, 'Crear nuevos clientes.', 'Permite al empleado crear un nuevo cliente.'),
    modificar: new Rol(
      16,
  ...
  empleados: new RolGroup('Empleados', {
    crear: new Rol(20, 'Crear nuevos empleados.', 'Permite al empleado crear un nuevo empleado.'),
    modificar: new Rol(
      21,
